  ...
  Future<void> _calcolaKmOSRM(TrattaViaggio tratta) async {
    ...
    try {
      ...
      if (p1 != null && p2 != null) {
        ...
        // Moltiplichiamo per 1. (coefficiente stradale standard per convertire la linea d'aria nei km reali percorsi su strada in Italia)
        double kmRealiStrada = distanzaLineaDaria * 1.0;
